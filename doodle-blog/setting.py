...
# APPID = 'abcdegf'
BLOG_TITLE = u'Blog@Cloudrive' # 博客标题
BLOG_SUB_TITLE = u"Techblog to be GFWed.."# 博客副标题
BLOG_DESCRIPTION = BLOG_SUB_TITLE # 用于FEED的博客描述
BLOG_AUTHOR = 'EggFly' # 博客作者
...
GOOGLE_ANALYTICS_ID = 'UA-22179046-1' # Google Analytics web property ID，没有就留空
...
ADMIN_EMAIL = 'lihaohua90@gmail.com' # 管理员邮箱，收发邮件时需要用到
