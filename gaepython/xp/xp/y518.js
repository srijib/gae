...
function item(w,img,txt,act){
	document.write("<td><table border='0' cellpadding='0' cellspacing='0' height='23' width="+w+" class=up1 title="+txt+"-www.y518.Com OnMouseout=this.className='up1' OnMouseDown=this.className='down';updown();GradientClose();"+act+"><tr><td valign='middle'><img  src=xp/"+img+".gif  hspace='3' align=absmiddle>"+txt+"-y518</td></tr></table></td>")}
function td(w){
...
function cs(nh)
	{css.href=nh;}
function finish()
	{hide("load");show('first');window.status="..::Welcome to y518.com::.."}
